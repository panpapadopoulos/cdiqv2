...
if (isset($_FILES['resume'])) {
	...
	$a->body_main = function () {
		...
		if (sizeof($jobs) === 0) {
			?>
				...
				<p>Don't worry, this might be an issue on our service. You can always explore <a
						href="https://careerday.fet.uop.gr/">all related job & intership positions</a>!</p>
				<?php
				return;
		}
	...
	$a->body_main = function () {
		?>
			...
			<p>Upload your resume (pdf or docx) and we will recommend interviewers with job and intership positions that are suited
				for you.</p>
			<h5 style="line-height: 1rem; text-align: center;">English resume versions are faster to process and produce more
				accurate results.</h5>
			...
			<a href="https://careerday.fet.uop.gr/companies.php">Explore all companies, job and intership positions!</a>
